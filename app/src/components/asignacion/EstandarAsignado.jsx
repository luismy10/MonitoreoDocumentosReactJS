...
import ModalMedioVerificacion from './ModalMedioVerificacion'
...
class EstandarAsignado extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            titleMedioVerificacion: "Registrar Medio de Verificación"
        }
    }
    ...
    openModalMedioVerificacion = () => {
        $("#modalMedioVerificacion").modal("show");
    ...
    render() {
        return (
            <>
                ...
                <ModalMedioVerificacion title={this.state.titleMedioVerificacion} />
                        ...
                        <div className="row">
                            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div className="form-group">
                                    <button className="btn btn-primary" id="btnAgregar" title="Agregar" onClick={this.openModalMedioVerificacion}>
