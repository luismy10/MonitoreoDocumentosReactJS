            ...
            <>
                ...
                <aside className="app-sidebar">
                    ...
                    <ul className="app-menu">
                        <li>
                            <Link to="dashboard" className="app-menu__item" id="tab-index">
                        ...
                        <li className="treeview" id="treeview-ingresos">
                            ...
                            <ul className="treeview-menu">
                                ...
                                <li>
                                    <a className="app-menu__item" id="tab-pago" href="pago.php">
                                        <i className="app-menu__icon fa fa-circle-o"></i>
                                ...
                                <li>
                                    <a className="app-menu__item" id="tab-guiaremision" href="#">
                                        <i className="app-menu__icon fa fa-circle-o"></i>
                        ...
                        <li className="treeview" id="treeview-egresos">
                            ...
                            <ul className="treeview-menu">
                                ...
                                <li>
                                    <a className="app-menu__item" id="tab-cobro" href="cobro.php">
                                        <i className="app-menu__icon fa fa-circle-o"></i>
                        ...
                        <li className="treeview" id="treeview-facturacion">
                            <a className="app-menu__item" href="#" data-toggle="treeview">
                                <i className="app-menu__icon fa fa-skyatlas rotate180"></i>
                            ...
                            <ul className="treeview-menu">
                                <li>
                                    <a
                                        className="app-menu__item"
                                        id="tab-cpeelectronicos"
                                        href="cpeelectronicos.php"
                                    >
                                        <i className="app-menu__icon fa fa-circle-o"></i>
                                ...
                                <li>
                                    <a
                                        className="app-menu__item"
                                        id="tab-consultaindividual"
                                        href="consultaindividual.php"
                                    >
                                        <i className="app-menu__icon fa fa-circle-o"></i>
                                ...
                                <li>
                                    <a
                                        className="app-menu__item"
                                        id="tab-consultaglobal"
                                        href="consultaglobal.php"
                                    >
                                        <i className="app-menu__icon fa fa-circle-o"></i>
                        ...
                        <li className="treeview" id="treeview-inventario">
                            ...
                            <ul className="treeview-menu">
                                ...
                                <li>
                                    <a
                                        className="app-menu__item"
                                        id="tab-kardexproducto"
                                        href="kardexproducto.php"
                                    >
                                        <i className="app-menu__icon fa fa-circle-o"></i>
                        ...
                        <li>
                            <a className="app-menu__item" id="tab-reporte" href="reporte.php">
