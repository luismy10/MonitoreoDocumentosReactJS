...
class ModalEstadoEstandar extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <div className="row" >
                <div className="modal fade" id="modalEstadoEstandar" data-backdrop="static">
                    <div className="modal-dialog modal-xl">
                        <div className="modal-content">

                            <div className="modal-header">
                                <h4 className="modal-title">
                                    <i className="fa fa-window-maximize"></i> {this.state.title} <small className="p-1 rounded bg-info text-white">{this.state.stateStandar}</small>
                                </h4>
...
export default ModalEstadoEstandar;
